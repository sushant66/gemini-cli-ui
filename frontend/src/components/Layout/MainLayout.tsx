                ...
                {activeChatSessions.size > 0 ? (
                  <>
                    <h3 className="mb-2 px-3 text-xs font-medium text-gray-500">
                      Chats ({activeChatSessions.size})
                    </h3>
                    <div className="space-y-1">
                      {Array.from(activeChatSessions.entries()).map(([sessionId, chatSession]) => (
                        <div
                          key={sessionId}
                          className="group flex items-center justify-between rounded-md px-3 py-2 text-left text-sm transition-colors hover:bg-gray-800 cursor-pointer bg-gray-800"
                        >
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              closeActiveChatSession(sessionId);
                            }}
                  ...
                  <div className="px-3 py-8 text-center">
                    <div className="text-gray-500 text-sm mb-2">No active chats</div>
